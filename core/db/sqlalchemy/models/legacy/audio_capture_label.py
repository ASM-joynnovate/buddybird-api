...
audio_capture_label_table = Table(
    ...
    metadata,
    Column("audio_capture_id", UUID, ForeignKey("legacy.audio_captures.id"), nullable=False),
    Column("label_option_id", UUID, ForeignKey("legacy.label_options.id"), nullable=False, index=True),
