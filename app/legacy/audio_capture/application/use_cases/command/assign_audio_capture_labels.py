...
from app.legacy.audio_capture.application.dto import AssignAudioCaptureLabelsDTO
from app.legacy.audio_capture.domain.commands import AssignAudioCaptureLabelsCommand
from app.legacy.audio_capture.domain.enums import LabelCategoryTargetEnum
from app.legacy.audio_capture.domain.interfaces.repositories import (
    IAudioCaptureRepo,
    ILabelCategoryRepo,
    ILabelOptionRepo,
)
