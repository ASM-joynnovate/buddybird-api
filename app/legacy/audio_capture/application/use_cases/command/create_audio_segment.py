...
from app.legacy.audio_capture.application.dto import CreateAudioSegmentDTO
from app.legacy.audio_capture.domain.commands import CreateAudioSegmentCommand
from app.legacy.audio_capture.domain.entities.audio_segment import AudioSegment
from app.legacy.audio_capture.domain.interfaces.repositories import IAudioCaptureRepo, IAudioSegmentRepo
from app.legacy.audio_capture.domain.interfaces.services import IAudioAnalyzer
