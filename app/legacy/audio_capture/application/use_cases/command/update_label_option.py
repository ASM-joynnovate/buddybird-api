...
from app.legacy.audio_capture.application.dto import UpdateLabelOptionDTO
from app.legacy.audio_capture.domain.commands import UpdateLabelOptionCommand
from app.legacy.audio_capture.domain.interfaces.repositories import ILabelOptionRepo
