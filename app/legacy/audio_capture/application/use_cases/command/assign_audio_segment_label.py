...
from app.legacy.audio_capture.application.dto import AssignAudioSegmentLabelDTO
from app.legacy.audio_capture.domain.commands import AssignAudioSegmentLabelCommand
