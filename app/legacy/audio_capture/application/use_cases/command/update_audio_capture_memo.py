...
from app.legacy.audio_capture.application.dto import UpdateAudioCaptureMemoDTO
from app.legacy.audio_capture.domain.commands import UpdateAudioCaptureMemoCommand
from app.legacy.audio_capture.domain.interfaces.repositories import IAudioCaptureRepo
