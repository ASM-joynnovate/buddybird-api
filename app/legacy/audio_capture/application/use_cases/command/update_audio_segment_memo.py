...
from app.legacy.audio_capture.application.dto import UpdateAudioSegmentMemoDTO
from app.legacy.audio_capture.domain.commands import UpdateAudioSegmentMemoCommand
