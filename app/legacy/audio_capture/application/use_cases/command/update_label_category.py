...
from app.legacy.audio_capture.application.dto import UpdateLabelCategoryDTO
from app.legacy.audio_capture.domain.commands import UpdateLabelCategoryCommand
