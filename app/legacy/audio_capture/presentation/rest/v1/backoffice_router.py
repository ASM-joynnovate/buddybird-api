...
from app.legacy.audio_capture.application.use_cases.command.assign_audio_capture_labels import (
    AssignAudioCaptureLabelsUseCase,
)
from app.legacy.audio_capture.application.use_cases.command.assign_audio_segment_label import (
    AssignAudioSegmentLabelUseCase,
)
from app.legacy.audio_capture.application.use_cases.command.create_audio_segment import CreateAudioSegmentUseCase
from app.legacy.audio_capture.application.use_cases.command.create_label_category import CreateLabelCategoryUseCase
from app.legacy.audio_capture.application.use_cases.command.create_label_option import CreateLabelOptionUseCase
from app.legacy.audio_capture.application.use_cases.command.delete_audio_segment import DeleteAudioSegmentUseCase
from app.legacy.audio_capture.application.use_cases.command.delete_label_category import DeleteLabelCategoryUseCase
from app.legacy.audio_capture.application.use_cases.command.delete_label_option import DeleteLabelOptionUseCase
from app.legacy.audio_capture.application.use_cases.command.detect_audio_segments import DetectAudioSegmentsUseCase
from app.legacy.audio_capture.application.use_cases.command.migrate_reviews import MigrateReviewsUseCase
from app.legacy.audio_capture.application.use_cases.command.trim_audio_segment import TrimAudioSegmentUseCase
from app.legacy.audio_capture.application.use_cases.command.update_audio_capture_memo import (
    UpdateAudioCaptureMemoUseCase,
)
from app.legacy.audio_capture.application.use_cases.command.update_audio_segment_memo import (
    UpdateAudioSegmentMemoUseCase,
)
from app.legacy.audio_capture.application.use_cases.command.update_label_category import UpdateLabelCategoryUseCase
from app.legacy.audio_capture.application.use_cases.command.update_label_option import UpdateLabelOptionUseCase
from app.legacy.audio_capture.application.use_cases.query.export_audio_segment import ExportAudioSegmentsUseCase
from app.legacy.audio_capture.application.use_cases.query.get_audio_capture_count import GetAudioCaptureCountUseCase
from app.legacy.audio_capture.application.use_cases.query.get_audio_capture_detail import GetAudioCaptureDetailUseCase
from app.legacy.audio_capture.application.use_cases.query.get_audio_capture_list import GetAudioCaptureListUseCase
from app.legacy.audio_capture.application.use_cases.query.get_label_list import GetLabelListUseCase
from app.legacy.audio_capture.presentation.rest.v1.dependencies import verify_backoffice_password
from app.legacy.audio_capture.presentation.rest.v1.request import (
...
from app.legacy.audio_capture.presentation.rest.v1.response import (
...
async def get_labels(
    use_case: Annotated[
        GetLabelListUseCase,
        Depends(Provide[AppContainer.legacy_audio_capture.get_label_list_query]),
    ],
) -> BaseResponse:
...
async def create_label_category(
    ...
    use_case: Annotated[
        CreateLabelCategoryUseCase, Depends(Provide[AppContainer.legacy_audio_capture.create_label_category_command])
    ],
) -> BaseResponse:
...
async def update_label_category(
    ...
    use_case: Annotated[
        UpdateLabelCategoryUseCase, Depends(Provide[AppContainer.legacy_audio_capture.update_label_category_command])
    ],
) -> BaseResponse:
...
async def delete_label_category(
    label_category_id: UUID,
    use_case: Annotated[
        DeleteLabelCategoryUseCase, Depends(Provide[AppContainer.legacy_audio_capture.delete_label_category_command])
    ],
) -> BaseResponse:
    return BaseResponse(
...
async def create_label_option(
    ...
    use_case: Annotated[
        CreateLabelOptionUseCase, Depends(Provide[AppContainer.legacy_audio_capture.create_label_option_command])
    ],
) -> BaseResponse:
...
async def update_label_option(
    ...
    use_case: Annotated[
        UpdateLabelOptionUseCase, Depends(Provide[AppContainer.legacy_audio_capture.update_label_option_command])
    ],
) -> BaseResponse:
...
async def delete_label_option(
    label_option_id: UUID,
    use_case: Annotated[
        DeleteLabelOptionUseCase, Depends(Provide[AppContainer.legacy_audio_capture.delete_label_option_command])
    ],
) -> BaseResponse:
    return BaseResponse(
        message="라벨 옵션 삭제 성공",
...
async def get_list(
    ...
    list_use_case: Annotated[
        ...
        Depends(Provide[AppContainer.legacy_audio_capture.get_audio_capture_list_query]),
    ],
    count_use_case: Annotated[
        GetAudioCaptureCountUseCase,
        Depends(Provide[AppContainer.legacy_audio_capture.get_audio_capture_count_query]),
    ],
) -> BaseResponse:
...
async def get_by_id(
    ...
    use_case: Annotated[
        ...
        Depends(Provide[AppContainer.legacy_audio_capture.get_audio_capture_detail_query]),
    ],
) -> BaseResponse:
    return BaseResponse(
...
async def create_audio_segment(
    ...
    use_case: Annotated[
        CreateAudioSegmentUseCase, Depends(Provide[AppContainer.legacy_audio_capture.create_audio_segment_command])
    ],
) -> BaseResponse:
...
async def detect_audio_segments(
    audio_capture_id: UUID,
    use_case: Annotated[
        DetectAudioSegmentsUseCase, Depends(Provide[AppContainer.legacy_audio_capture.detect_audio_segments_command])
    ],
) -> BaseResponse:
    return BaseResponse(
...
async def trim_audio_segment(
    ...
    use_case: Annotated[
        TrimAudioSegmentUseCase, Depends(Provide[AppContainer.legacy_audio_capture.trim_audio_segment_command])
    ],
) -> BaseResponse:
...
async def assign_audio_segment_label(
    ...
    use_case: Annotated[
        AssignAudioSegmentLabelUseCase,
        Depends(Provide[AppContainer.legacy_audio_capture.assign_audio_segment_label_command]),
    ],
) -> BaseResponse:
...
async def update_audio_segment_memo(
    ...
    use_case: Annotated[
        UpdateAudioSegmentMemoUseCase,
        Depends(Provide[AppContainer.legacy_audio_capture.update_audio_segment_memo_command]),
    ],
) -> BaseResponse:
...
async def delete_audio_segment(
    audio_segment_id: UUID,
    use_case: Annotated[
        DeleteAudioSegmentUseCase, Depends(Provide[AppContainer.legacy_audio_capture.delete_audio_segment_command])
    ],
) -> BaseResponse:
    return BaseResponse(
...
async def assign_audio_capture_labels(
    ...
    use_case: Annotated[
        AssignAudioCaptureLabelsUseCase,
        Depends(Provide[AppContainer.legacy_audio_capture.assign_audio_capture_labels_command]),
    ],
) -> BaseResponse:
...
async def update_audio_capture_memo(
    ...
    use_case: Annotated[
        UpdateAudioCaptureMemoUseCase,
        Depends(Provide[AppContainer.legacy_audio_capture.update_audio_capture_memo_command]),
    ],
) -> BaseResponse:
...
async def migrate_reviews(
    ...
    use_case: Annotated[
        ...
        Depends(Provide[AppContainer.legacy_audio_capture.migrate_reviews_command]),
    ],
) -> BaseResponse:
...
async def export_audio_segments(
    ...
    use_case: Annotated[
        ExportAudioSegmentsUseCase, Depends(Provide[AppContainer.legacy_audio_capture.export_audio_segments_query])
    ],
) -> Response:
    return Response(
